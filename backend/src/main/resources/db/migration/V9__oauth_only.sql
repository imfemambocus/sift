-- the pasted-token path was removed on 2026-08-07: a source is authorized through OAuth or not at
-- all, so PERSONAL_ACCESS_TOKEN is no longer a value CredentialType can read and any row still
-- carrying it would fail on the next read of the table.
--
